...
public partial class CustomEditorTools
{
    ...
    public static float FloatFastParse(string floatValue)
    {
        int flag = 1;
        bool doted = false;
        int dever = 1;
        ...
        int ret = 0;
        char fChar;
        for (int index = 0, xLength = floatValue.Length; index < xLength; ++index)
        {
            fChar = floatValue[index];
            switch (fChar)
            {
                case '0':
                case '1':
                ...
                case '9':
                    ...
                    break;
                case '.': doted = true; break;
                case '-': flag = -1; break;
                default: break;
            }
        }
        double r = ((double)ret) / dever;
        r *= flag;
        return (float)r;
    }
