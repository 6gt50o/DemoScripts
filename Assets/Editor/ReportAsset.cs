...
public partial class ReportAsset
{
    ...
    static void StaticRef()
    {
        Debug.Log("EditorApplication.isCompiling:" + EditorApplication.isCompiling 
            + " EditorApplication.isPlaying:" + EditorApplication.isPlaying + " Network:" + (Application.internetReachability == NetworkReachability.NotReachable)
            + (Application.internetReachability == NetworkReachability.ReachableViaCarrierDataNetwork)//2G 3G 4G
            + (Application.internetReachability == NetworkReachability.ReachableViaLocalAreaNetwork)//wifi or network
        );
